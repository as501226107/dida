...
<div class="layui-container" style="margin-top: 5px">
    <form class="layui-form" action="${pageContext.request.contextPath}/emp/add" method="post" enctype="multipart/form-data" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <img alt="个人一寸照片" src="${pageContext.request.contextPath}/img/head/default/default.png"  id="img1" width="200px" height="200px">
            </div>
        </div>
        <div class="layui-form-item">
