...
<div class="layui-container" style="margin-top: 5px">
    <form class="layui-form" action="${pageContext.request.contextPath}/emp/update" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="${emp.id}"/>
        <div class="layui-form-item">
            <label class="layui-form-label">员工工号</label>
            <div class="layui-input-block">
                <input type="text" name="no" value="${emp.no}" disabled lay-verify="name" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" value="${emp.name}" lay-verify="name" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="createdate" value="${emp.createdate}"  id="date" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
        ...
        .use(
            ...
            function() {
                ...
                var uploadInst = upload.render({
                    elem: '#upfile' //绑定元素
                    ,url: '${pageContext.request.contextPath}/emp/uploade' //上传接口
                    ,done: function(obj){
                        //上传完毕回调
                        console.log(obj);
                        if(obj.code==1000){
                            $("#p1").val(obj.msg);
                            $("#img1")[0].src="${pageContext.request.contextPath}/img/"+obj.msg;
                            $("#btn1").attr("disabled",false);
                        }else{
                            $("#img1")[0].src="${pageContext.request.contextPath}/img/head/default/default.png";
                        }
    ...
    //初始化数据
    function initData() {
        $.get("${pageContext.request.contextPath}/depart/lists",null,function(arr){
