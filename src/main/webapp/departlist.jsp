...
<head>
    ...
    <script type="text/javascript">
        ...
        function goPage(pageIndex){
            ...
            $("#departForm").attr("action","${pageContext.request.contextPath}/depart/list/"+pageIndex+"?pageSize="+pageSize);
            $("#departForm").submit(); //提交表单参数
        }
        //跳转到某个页面
        function tiao(){
        ...
        function bian(){
            var pageSize=$("#pageSize").val();
            $("#departForm").attr("action","${pageContext.request.contextPath}/depart/list/1?pageSize="+pageSize);
            $("#departForm").submit(); //提交表单参数
        }
...
<div class="layui-container">
    <form action="${pageContext.request.contextPath}/depart/list/1" method="post" id="departForm"></form>
            ...
            <tr>
                ...
                <td>
                    <shiro:hasPermission name="depart:update">
                        <a class="layui-btn layui-btn-mini" href="${pageContext.request.contextPath}/depart/pageToUpage/${d.id}">编辑</a>
                    </shiro:hasPermission>
                    <shiro:hasPermission name="depart:delete">
                         <a class="layui-btn layui-btn-danger layui-btn-mini" lay-event="del" onclick="deleteCourse(${d.id});">删除</a>
                    </shiro:hasPermission>
