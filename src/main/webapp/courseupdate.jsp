...
<div class="layui-container" style="margin-top: 5px">
    <form class="layui-form" action="${pageContext.request.contextPath}/course/update" method="post">
                <input type="hidden" name="id" value="${course.id}" readonly="readonly" autocomplete="off"
                       class="layui-input" id="f1">
        <div class="layui-form-item">
            <label class="layui-form-label">学科名称</label>
            <div class="layui-input-block">
                <input type="text" name="name" value="${course.name}" id="f2" lay-verify="name" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="${course.createdate}" name="createdate" readonly="readonly" id="f3" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">学科周期</label>
            <div class="layui-input-block">
                <input type="text" name="week" value="${course.week}" id="f4" lay-verify="name" autocomplete="off"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="${course.type}" name="type" id="f5" lay-verify="name" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
