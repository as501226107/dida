...
<head>
    ...
    <script type="text/javascript">
        ...
        function goPage(pageIndex){
            ...
            $("#gradeForm").attr("action","${pageContext.request.contextPath}/course/list/"+pageIndex+"?pageSize="+pageSize);
        ...
        function bian(){
            var pageSize=$("#pageSize").val();
            $("#gradeForm").attr("action","${pageContext.request.contextPath}/course/list/1?pageSize="+pageSize);
            $("#gradeForm").submit(); //提交表单参数
        }
...
<body>
<form action="${pageContext.request.contextPath}/course/list/1" method="post" id="gradeForm"></form>
    ...
    <table class="layui-table" id="tbdata" lay-filter="tbop">
        ...
        <c:forEach items="${pageBean.list}" var="c">
            <tr>
                ...
                <td>${c.createdate}</td>
                <td>${c.type}</td>
                <td><a class="layui-btn layui-btn-mini" href="${pageContext.request.contextPath}/course/pageToUpdate/${c.id}">编辑</a>
                    <a class="layui-btn layui-btn-danger layui-btn-mini"
                       lay-event="del" onclick="deleteCourse(${c.id});">删除</a></td>
            </tr>
        </c:forEach>
